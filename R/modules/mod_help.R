    ...
    shiny::fluidRow(
      shinydashboard::box(
        ...
        shiny::tags$ul(
          ...
          shiny::tags$li("Roche Digital LightCycler CSV: Kanalspalten im Wide-Format (`Channel1...ChannelN`) plus `Flag`; `plate_name` wird vor dem ersten `_` und `sample` nach dem letzten `_` aus dem Dateinamen gelesen."),
        ...
        shiny::tags$ul(
          ...
          shiny::tags$li("UI-Einstellungen werden pro User-ID im Browser gespeichert (bevorzugt localStorage, sonst Cookie-Fallback).")
        ),
        shiny::h4("FAQ"),
        shiny::tags$dl(
          ...
          shiny::tags$dd("Aktuell Qiagen QIAcuity und Roche Digital LightCycler. Bio-Rad ist als Erweiterung vorbereitet."),
